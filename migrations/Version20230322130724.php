 ...
 */
final class Version20230322130724 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE messenger ADD CONSTRAINT FK_E22A4301676C7AF5 FOREIGN KEY (messenger_id) REFERENCES messenger (id)');
